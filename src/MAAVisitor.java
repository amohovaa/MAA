...
public interface MAAVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExprCond(MAAParser.ExprCondContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitComparison(MAAParser.ComparisonContext ctx);
	/**
	 * Visit a parse tree produced by {@link MAAParser#conditionunion}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditionunion(MAAParser.ConditionunionContext ctx);
	/**
